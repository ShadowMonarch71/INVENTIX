...
from app.api.routes import analysis, research, patent, knowledge, upload, auth, projects, antigravity
...
router.include_router(antigravity.router, prefix="/antigravity", tags=["ANTIGRAVITY Core"])
